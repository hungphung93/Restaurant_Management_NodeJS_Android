...
public class OrderListAdapter extends RecyclerView.Adapter<OrderListAdapter.ViewHolder> {
    ...
    OrderListAdapter(Context context, ArrayList<Order> orders) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if (order.getOrderStatus().equalsIgnoreCase("On Line")) {
            holder.orderStatus.setTextColor(mContext.getResources().getColor(R.color.darkYellow));
            ...
            holder.orderStatus.setTextColor(mContext.getResources().getColor(R.color.darkGreen));
        } else if (order.getOrderStatus().equalsIgnoreCase("Cooking")) {
            holder.orderStatus.setTextColor(mContext.getResources().getColor(R.color.blue));
        }
    }
